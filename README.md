...
谢谢桂姗同学给我这样一个机会，帮助他人的同时，也能够再一次实践爬虫基础知识。抱歉第一次将网站弄崩溃，耽误了她不少宝贵时间，不过好在完成了基本任务。

路漫漫其修远兮，吾将上下而求索。这个小项目至少给我两点体会：

- “反爬”和“负载均衡”是一个好的网站服务器的基础，尤其是数据库网站服务器。
- 除了网络编程，其他诸如机器学习、模式识别等专业领域，python也总是能给人们一个又一个惊喜，必须更加熟练地掌握和运用它。

最后，祝愿上海财经大学的两位高中童鞋：桂姗、钱健健，都能前程似锦、天天开心 O(∩\_∩)
